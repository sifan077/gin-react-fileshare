...
`,ue=a.div`
  ...
  border-radius: 8px;
`,de=({container:e,onClickOverlay:n,children:r})=>A.exports.createPortal(u(le,{children:[t(ce,{onClick:n}),t(ue,{children:r})]}),e!=null?e:document.body);let k=null;const I=e=>{!e||(A.exports.unmountComponentAtNode(e),e.remove(),k=null)},L=(e,n={})=>{I(k);const{closeOnClickOverlay:r,context:s}=n,o=k=document.createElement("div");o.className="tempApp",document.body.append(o);const i=()=>{r&&I(o)};return A.exports.render(t(b.Provider,{value:s,children:t(de,{container:o,onClickOverlay:i,children:e})}),o),()=>I(o)},h=a.div`
  display: flex;
